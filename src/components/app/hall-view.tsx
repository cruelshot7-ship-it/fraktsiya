      ...
      <div className="stagger-in flex flex-col gap-3">
        ...
        {machine.exercises.map((item) => (
          ...
          >
            ...
            <span className="mt-1 block text-xs text-muted-foreground">техника + повтори движение</span>
          </button>
        ))}
      </div>
    );
    ...
    <div className="stagger-in flex flex-col gap-3">
      ...
      <Surface className="overflow-hidden p-0" glow="alert">
        <div className="px-4 pt-4">
          <SectionLabel>Повтори движение</SectionLabel>
          <p className="mt-1 text-xs text-muted-foreground">
            Ведите палец по призрачной дуге. Три повтора — оценка «как у грифа».
          </p>
        </div>
        <FormCanvas
          kind={exercise.path}
